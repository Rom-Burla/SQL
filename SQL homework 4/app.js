...
app.get('/customer-club', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
app.post('/getCustPhone', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    connection.query(`SELECT * FROM \`users\` JOIN child_age ON child_age.user_id=users.id WHERE \`phone\`= ?`, [phoneInp.toString()], (err, result) => {
        if (err)
            throw err;
        if (result.length > 0) {
            app.get("/customer-club/" + phoneInp + "/children", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            app.get("/customer-club/" + phoneInp, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
